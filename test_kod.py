...
edges = [
    {"from": "ZG", "to": "ZR", "km": 44.90, "droga": "DK27", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZG", "to": "ZR", "km": 48.70, "droga": "DK32 + DK27", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZG", "to": "ZA", "km": 46.20, "droga": "DK27 + DW295", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZG", "to": "ZA", "km": 58.20, "droga": "S3 + DW296", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZG", "to": "SZP", "km": 53.60, "droga": "S3 + DW297", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZG", "to": "SZP", "km": 58.10, "droga": "S3", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZG", "to": "SZP", "km": 51.60, "droga": "DW283 + DW297", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "ZG", "to": "KOZ", "km": 32.00, "droga": "S3 + DW297", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZG", "to": "KOZ", "km": 36.10, "droga": "S3", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZG", "to": "KOZ", "km": 28.20, "droga": "DW283", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "ZG", "to": "NB", "km": 25.50, "droga": "DW282 + DK27", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZG", "to": "NS", "km": 26.60, "droga": "S3", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.90},
    {"from": "ZG", "to": "NS", "km": 23.20, "droga": "S3 + Zielonogorska", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.90},
    {"from": "NB", "to": "SZP", "km": 40.10, "droga": "DW295 + DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "NB", "to": "ZR", "km": 19.90, "droga": "DK27", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "NB", "to": "ZR", "km": 21.60, "droga": "DK27 + Obwodnica", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "NB", "to": "ZA", "km": 23.10, "droga": "DW295", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "NB", "to": "ZA", "km": 33.10, "droga": "DK27 + DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "NB", "to": "KOZ", "km": 31.40, "droga": "DW290", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "NB", "to": "NS", "km": 39.90, "droga": "DW290", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "NB", "to": "NS", "km": 54.40, "droga": "DK27 + S3", "predkoscMax": 120, "predkoscSrednia": 87, "natezenieRuchu": 0.80},
    {"from": "ZR", "to": "ZA", "km": 15.10, "droga": "DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.80},
    {"from": "ZR", "to": "ZA", "km": 18.30, "droga": "Obwodnica + DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.80},
    {"from": "ZR", "to": "SZP", "km": 32.20, "droga": "DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZR", "to": "KOZ", "km": 40.70, "droga": "DK12 + DW296", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZR", "to": "NS", "km": 52.40, "droga": "DW296", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "ZA", "to": "SZP", "km": 17.60, "droga": "DK12", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70},
    {"from": "ZA", "to": "KOZ", "km": 26.10, "droga": "DW296", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "ZA", "to": "NS", "km": 37.90, "droga": "DW296", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "SZP", "to": "KOZ", "km": 22.60, "droga": "DW297", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "SZP", "to": "NS", "km": 34.30, "droga": "DW297", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.60},
    {"from": "KOZ", "to": "NS", "km": 11.70, "droga": "DW297", "predkoscMax": 90, "predkoscSrednia": 65, "natezenieRuchu": 0.70}
]
...
def buduj_harmonogram_globalny(zadania_miast):
    ...
    while any(len(zadania_miast[m]) > 0 for m in zadania_miast):
        ...
        while skumulowany_czas_min < MAKS_CZAS_ZMIANY_MIN:
            ...
            if not pierwszy_kurs:
                if skumulowany_czas_min + CZAS_ZALADUNKU_BAZA_MIN < MAKS_CZAS_ZMIANY_MIN:
                    if not przerwa_odbyta and skumulowany_czas_min >= celowany_czas_przerwy:
                        logi_etapow.append(f"[{formatuj_godzine(skumulowany_czas_min)}] Przerwa ustawowa (20 min) - rozpoczęta w bazie.")
            ...
            for kod_miasta in porzadek:
                ...
                if przyszly_czas <= MAKS_CZAS_ZMIANY_MIN:
                    ...
                    # --- [OPCJA B] KOREKTA FILTRU NADGODZIN ---
                    # Zablokowaliśmy automatyczną zgodę na nadgodziny dla obecnego kierowcy.
                    # Zmuszamy algorytm do otwarcia NOWEGO KURIERA (czyli zrobienia pełnego dnia pracy 8h dla kogoś innego),
                    # zamiast przemęczać obecnego pracownika i tworzyć dysproporcje w postaci "pustych 1.5-godzinnych" końcówek floty.
                    akceptuj_paczke = False
        ...
        if not przerwa_odbyta and skumulowany_czas_min < MAKS_CZAS_ZMIANY_MIN:
            skumulowany_czas_min += CZAS_PRZERWY_MIN
...
def wczytaj_i_optymalizuj():
    ...
    path_without_ext = sciezka_csv.rsplit('.', 1)[0] if '.' in sciezka_csv else sciezka_csv
    sciezka_wyjsciowa = f"{path_without_ext}_raport.txt"

    tee = Tee(sciezka_wyjsciowa)
    try:
    ...
    print(f"\n[INFO] Pełny raport został zapisany do pliku: {sciezka_wyjsciowa}")
